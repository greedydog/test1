...
import 'package:flutter_test_project/pages/music_list_page/cubit/music_list_page_info_states.dart';

class MusicListPageInfoCubits extends Cubit<List<MusicListPageInfoState>> {
  MusicListPageInfoCubits() : super([]);
  ...
  addPageInfo(String? name, int? index, Color? color) {
    ...
    emit([
      MusicListPageInfoState(name: name, index: index, color: color),
      ...state
    ]);
